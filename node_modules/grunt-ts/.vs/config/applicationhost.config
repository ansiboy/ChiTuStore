...
<configuration>
    ...
    <system.applicationHost>
        ...
        <sites>
            ...
            <site name="grunt-ts" id="2">
                <application path="/" applicationPool="Clr4IntegratedAppPool">
                    <virtualDirectory path="/" physicalPath="C:\Users\Steve\Documents\GitHub\grunt-ts" />
                </application>
                <bindings>
                    <binding protocol="http" bindingInformation="*:10690:localhost" />
                </bindings>
            </site>
            <siteDefaults>
