define(["require", "exports", 'move', 'text!Module/Home/ProductList/ProductsFilter.html', 'iscroll'], function (require, exports, move, html, IScroll) {
    var win_width = $(window).width();
    var width = win_width * 0.8;
